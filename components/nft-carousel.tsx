    ...
    <section className="relative w-full overflow-hidden py-12 bg-black/50">
      ...
      <div className="text-center mb-8">
        ...
        <p className="text-gray-400">
          Discover unique digital assets on Bitcoin SV
        </p>
      </div>
        ...
        >
          {allImages.map((image, index) => (
            ...
            >
              ...
              {/* Image */}
              {/* biome-ignore lint/performance/noImgElement: Remote CDN image list is rendered in a high-frequency scrolling carousel */}
              <img
                src={image.src}
                alt={image.alt}
