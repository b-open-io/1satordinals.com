...
export default async function StickersPage() {
  const stickers = await getProducts();

  return (
    <div className="flex flex-col">
      <section className="border-b border-border bg-gradient-to-b from-background to-muted/20 py-16">
        <div className="container mx-auto max-w-7xl px-4">
          <h1 className="text-4xl font-bold">Fox Stickers</h1>
          <p className="mt-2 text-muted-foreground">
            Adorable fox stickers perfect for laptops, water bottles, and more
          </p>
        </div>
      </section>
        ...
        <div className="container mx-auto max-w-7xl px-4">
          {stickers.length === 0 ? (
            <p className="text-center text-muted-foreground py-12">
              No stickers available at the moment. Check back soon!
            </p>
          ) : (
